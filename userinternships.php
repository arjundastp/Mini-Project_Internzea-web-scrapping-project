<?php
include('config.php');
$query = "select * from internships where name IS NOT NULL";
...
<body>
    ...
    <div class="main-content">
        <div class="search-controls">
            <a  href="searchgoogle.php"   ><button class="btn btn-primary">Search Internships with Name</button></a>
        ...
        <div class="container">
            ...
            <div class="card col-xs-12 col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="card-details text-danger">
                      <p style="" class=" mt-2 text-title"><?php echo $row['name']?></p>
                      <p style="" class=" mt-2 text-body">Providing Company <?php echo $row['provider']?></p>
                      
                      <p style=""  class="text-danger  text-body"><b>Added By : <?php echo $row['username']?> </p></b>
                </div>
                <a  href="<?php echo $row['link']?>"   ><button class="card-button">Visit Website</button></a>
            </div>
            <?php
            }
            ?>
