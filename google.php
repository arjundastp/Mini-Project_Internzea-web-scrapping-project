<?php
include('config.php');
$query = "select * from google where name IS NOT NULL";
    ...
    <div class="main-content">
        ...
        <div class="container">
            ...
            <div class="card col-xs-12 col-sm-6 col-md-6 col-lg-4 col-xl-3">
                ...
                <a  href="https://www.google.com/about/careers/applications/jobs/results/"   ><button class="card-button">Visit Website</button></a>
            </div>
            <?php
            }
            ?>
